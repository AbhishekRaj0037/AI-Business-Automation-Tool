"""Added new columns for separation of user in the app

Revision ID: 2632cd224da5
Revises: 9b9f995036d8
Create Date: 2026-04-11 14:23:03.245233
...
revision: str = '2632cd224da5'
down_revision: Union[str, Sequence[str], None] = '9b9f995036d8'
...
def upgrade() -> None:
    ...
    op.alter_column('dashboard_update', 'user_id',
               existing_type=sa.INTEGER(),
               type_=sa.String(),
               existing_nullable=True)

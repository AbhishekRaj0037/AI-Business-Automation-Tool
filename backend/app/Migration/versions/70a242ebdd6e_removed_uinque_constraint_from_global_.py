"""Removed uinque constraint from global imap_uid in email_metadata model

Revision ID: 70a242ebdd6e
Revises: d7b63590fbc1
Create Date: 2026-05-12 09:48:11.496236
...
def upgrade() -> None:
    ...
    op.create_unique_constraint(None, 'EmailData', ['user_id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'EmailData', type_='unique')
